...
// sdate is start date, cdate is close date, stage is which stage the deal is in, notes is any additional notes or deal closed reason
...
// parse through to retreive the stored array as an array
function s_read(key){
...
// returns the value held in the property 
...
// used in conjunction with con_table
...
// This is the function used to dynamically build tables across multiple places 
// This is the function used as an example in our computational thinking document
...
// These are from course material demo_form.js I made a similar attempt to use innerHTMl to write out the rows of the dynamic table
...
// type will determine which constructor and which kind of table to build to call 
...
// calculate total commission based on sales and commission formula set by the manager
